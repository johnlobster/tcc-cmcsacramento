...
const fetch = __webpack_require__(68);
const dns = __webpack_require__(37);
...
const Cookies = __webpack_require__(200);
const packageData = __webpack_require__(27);
...
const base64 = __webpack_require__(114);
const qp = __webpack_require__(115);
const mimeTypes = __webpack_require__(112);
...
var arrayLikeToArray = __webpack_require__(82);
...
const packageInfo = __webpack_require__(27);
...
const DataStream = __webpack_require__(212);
const PassThrough = __webpack_require__(1).PassThrough;
...
const mimeFuncs = __webpack_require__(69);
const qp = __webpack_require__(115);
const base64 = __webpack_require__(114);
const addressparser = __webpack_require__(202);
const fetch = __webpack_require__(68);
const LastNewline = __webpack_require__(203);
...
const Mailer = __webpack_require__(199);
const shared = __webpack_require__(18);
const SMTPPool = __webpack_require__(210);
const SMTPTransport = __webpack_require__(214);
const SendmailTransport = __webpack_require__(215);
const StreamTransport = __webpack_require__(217);
const JSONTransport = __webpack_require__(218);
const SESTransport = __webpack_require__(219);
const fetch = __webpack_require__(68);
const packageData = __webpack_require__(27);
...
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67);
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var nodemailer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(194);
...
__webpack_require__(45).config(); // add variables in .env file to process.env
...
var subject = "Contact received from CMC Sacramento web page";
/*
...
var ppBody = function ppBody(body) {
  var outputString = "";
...
function _handler() {
  _handler = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event) {
    var entryTime, emailList, setupOptions, transporter, tVerify, sendTime, rTime, messageBody, mess, mailMessage, i, info, exitTime, runTime;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            entryTime = new Date();
            console.log("Handler called by website ".concat(event.headers.host, " ").concat(entryTime));
            console.log(event); // check all environment variables

            if (!(!process.env.EMAIL_ADDRESS || !process.env.NODEMAILER_HOST || !process.env.NODEMAILER_PORT || !process.env.NODEMAILER_SECURE || !process.env.NODEMAILER_AUTH_USERNAME || !process.env.NODEMAILER_AUTH_PASSWORD)) {
              _context.next = 6;
              break;
            }
          ...
          case 19:
            ...
            console.log("function called by ".concat(event.headers.host, " was not POST ( ").concat(event.httpMethod, ")"));
            console.log("Message body\n".concat(event.body));
            return _context.abrupt("return", {
              statusCode: 400,
              body: "Error: function called by ".concat(event.headers.host, " was not POST ( ").concat(event.httpMethod, ")")
            });
          ...
          case 23:
            ...
            setupOptions = {
              ...
              // cast to boolean, default to secure
              auth: {
                user: process.env.NODEMAILER_AUTH_USERNAME,
                pass: process.env.NODEMAILER_AUTH_PASSWORD
              }
            };
            transporter = nodemailer__WEBPACK_IMPORTED_MODULE_3__["createTransport"](setupOptions);
            _context.prev = 25;
            _context.next = 28;
            return transporter.verify();

          case 28:
            tVerify = _context.sent;
            _context.next = 37;
            break;
          ...
          case 37:
            sendTime = new Date();
            rTime = new Date(sendTime.valueOf() - entryTime.valueOf());
            console.log("Verified nodemailer connection after ".concat(rTime.getSeconds(), " seconds")); //////////////////////////////////////////////////////////////////////////////////
            // Send email to list
            ...
            */
            ...
            mailMessage = "\n  A website contact from ".concat(event.headers.host, " was received ").concat(entryTime.toDateString(), "\n\n  ").concat(messageBody, "\n\n  Sent by \"mailer.js\" from ").concat(event.path, " ").concat(entryTime.getHours(), ":").concat(entryTime.getMinutes(), ":").concat(entryTime.getSeconds(), "\n  ");
            i = 0;
          ...
          case 44:
            ...
            _context.prev = 45;
            console.log("Sending mail message ".concat(i + 1, " to ").concat(emailList[i]));
            _context.next = 49;
          ...
          case 61:
            exitTime = new Date();
            runTime = new Date(exitTime.valueOf() - entryTime.valueOf());
            console.log("Function completed at ".concat(exitTime));
            console.log("Function took ".concat(runTime.getSeconds(), " seconds to run. Started ").concat(exitTime, "\n\n"));
            return _context.abrupt("return", {
              statusCode: 200,
              body: "mailer.ts completed in ".concat(runTime.getSeconds(), " seconds")
            });
...
const shared = __webpack_require__(18);
const mimeTypes = __webpack_require__(112);
const MailComposer = __webpack_require__(201);
const DKIM = __webpack_require__(204);
const httpProxyClient = __webpack_require__(208);
const util = __webpack_require__(0);
const urllib = __webpack_require__(3);
const packageData = __webpack_require__(27);
const MailMessage = __webpack_require__(209);
const net = __webpack_require__(14);
const dns = __webpack_require__(37);
const crypto = __webpack_require__(2);
...
const MimeNode = __webpack_require__(113);
const mimeFuncs = __webpack_require__(69);
...
const MessageParser = __webpack_require__(205);
const RelaxedBody = __webpack_require__(206);
const sign = __webpack_require__(207);
const PassThrough = __webpack_require__(1).PassThrough;
const fs = __webpack_require__(12);
const path = __webpack_require__(13);
const crypto = __webpack_require__(2);
...
const EventEmitter = __webpack_require__(16);
const PoolResource = __webpack_require__(211);
const SMTPConnection = __webpack_require__(84);
const wellKnown = __webpack_require__(117);
const shared = __webpack_require__(18);
const packageData = __webpack_require__(27);
...
const SMTPConnection = __webpack_require__(84);
const assign = __webpack_require__(18).assign;
const XOAuth2 = __webpack_require__(116);
const EventEmitter = __webpack_require__(16);
...
const spawn = __webpack_require__(216).spawn;
const packageData = __webpack_require__(27);
const LeWindows = __webpack_require__(85);
