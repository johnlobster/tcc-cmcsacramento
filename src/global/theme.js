...
var makeGlobalsFromTheme_1 = __importDefault(require("./makeGlobalsFromTheme"));
// Typography constants
exports.ratio = 1.333333333333333333;
exports.rhythm = 1.5;
// Problems with theme
...
var initialTheme = styles_1.createMuiTheme({
    palette: {
        primary: {
        ...
        text: {
            ...
            primaryColor: 'rgb(172, 53, 170)',
            primaryColorDark: 'rgb(84, 24, 83)',
    ...
    typography: {
        ...
        h1: {
            ...
            // mobile first
            // h2 setting
            fontSize: exports.rhythm * 2 + "rem",
            lineHeight: 2.5 * exports.rhythm + "rem",
            marginBlockStart: 0,
            paddingTop: exports.rhythm * 1.5 + "rem",
            marginBlockEnd: exports.rhythm * 0.5 + "rem",
            '@media screen and (min-width:600px)': {
                fontSize: 2.7 * exports.rhythm + "rem",
                lineHeight: 3 * exports.rhythm + "rem",
                marginBlockStart: 0,
                // reduced padding at top by 1 rhythm
                paddingTop: exports.rhythm + "rem",
                marginBlockEnd: exports.rhythm + "rem"
            }
        },
        h2: {
            // mobile first
            // h3 setting
            fontSize: (1.4 * exports.rhythm) + "rem",
            lineHeight: (2 * exports.rhythm) + "rem",
            marginBlockStart: 0,
            paddingTop: exports.rhythm * 1.6 + "rem",
            marginBlockEnd: exports.rhythm * 0.4 + "rem",
            '@media screen and (min-width:600px)': {
                fontSize: exports.rhythm * 2 + "rem",
                lineHeight: 2.5 * exports.rhythm + "rem",
                marginBlockStart: 0,
        ...
        h3: {
            // mobile first
            // h4 setting
            fontSize: 0.95 * exports.rhythm + "rem",
            lineHeight: (1.5 * exports.rhythm) + "rem",
            marginBlockStart: 0,
            paddingTop: exports.rhythm * 0.6 + "rem",
            marginBlockEnd: exports.rhythm * 0.4 + "rem",
            '@media screen and (min-width:600px)': {
                fontSize: (1.4 * exports.rhythm) + "rem",
                lineHeight: (2 * exports.rhythm) + "rem",
        ...
        h4: {
            fontSize: '1rem',
            lineHeight: exports.rhythm + "rem",
            marginBlockStart: 0,
            paddingTop: exports.rhythm * 0.7 + "rem",
            marginBlockEnd: exports.rhythm * 0.3 + "rem",
        ...
        h6: {
            fontSize: exports.ratio + "rem",
            lineHeight: exports.ratio * exports.rhythm + "rem",
            marginBlockStart: 0,
            marginBlockEnd: exports.ratio * exports.rhythm + "rem",
            fontWeight: 500
        }
    },
    transitions: {
    ...
    overrides: {
        MuiCssBaseline: {
            '@global': {
                ...
                'ul, ol': {
                    paddingLeft: exports.rhythm + "rem"
                },
                dl: {
...
var theme = makeGlobalsFromTheme_1["default"](initialTheme, ['h1', 'h2', 'h3', 'h4', 'h5', 'h6']);
